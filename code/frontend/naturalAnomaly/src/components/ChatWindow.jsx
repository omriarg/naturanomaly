        ...
        const handleResponse = (data) => {
            ...
            if (data.image) {
                ...
                botMessage = {
                    ...
                    summary: data.Table.summary || null,  // Add this line to capture summary if available
                };
            } else {
                botMessage = {
                    sender: 'bot',
                    content: data.response || 'The bot did not return a response.',
                };
            }
                    ...
                    {messages.length === 0 ? (
                        ...
                        messages.map((msg, index) => (
                            <Box key={index} sx={{ marginBottom: '10px' }}>
                                {msg.sender === 'user' ? (
                                    <Typography variant="body2">👤 You: {msg.content}</Typography>
                                ) : msg.image ? (
                                    <>
                                        <Typography variant="body2">🤖 Bot sent an image (click to enlarge):</Typography>
                                        <img
                                            src={msg.image}
                                            alt="Heatmap"
                                    ...
                                    <Box sx={{ overflowX: 'auto', mt: 1 }}>
                                        <Typography variant="body2" sx={{ mb: 1 }}>📊 Table:</Typography>
                                    ...
                                    <Typography variant="body2">🤖 Bot: {msg.content}</Typography>
                                )}
                            </Box>
                        ))
